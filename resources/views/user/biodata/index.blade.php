            ...
            @if (isset($biodataSiswa) && $biodataSiswa)
                <div class="bg-white shadow rounded-lg p-6 mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg ">
                            <h3 class="font-medium text-gray-800 mb-1">Jurusan Yang Dipilih</h3>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            @if ($biodataSiswa->foto_ijazah)
                                ...
                                {{-- Preview Gambar --}}
                                <img src="{{ asset('storage/' . $biodataSiswa->foto_ijazah) }}" alt="Preview Foto Ijazah"
                                    class="w-32 h-32 object-cover mx-auto rounded-lg border border-gray-200 mt-2">
                            @else
                                <p class="text-gray-600">Belum diunggah</p>
                            @endif
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            @if ($biodataSiswa->foto_formal)
                                ...
                                {{-- Preview Gambar --}}
                                <img src="{{ asset('storage/' . $biodataSiswa->foto_formal) }}" alt="Preview Foto Formal"
                                    class="w-32 h-32 object-cover mx-auto rounded-lg border border-gray-200 mt-2">
                            @else
                                <p class="text-gray-600">Belum diunggah</p>
                            @endif
